...
#line = LINE('EKy4hbMp45ri05ny2dJ5.LhYv9wQXTIaiXheiXUX2fq.pnoHUxV8v7UBn8T9lTyeKW5R11eqpxEBstIDxXgt/w0=')    
#line.log("Auth Token : " + str(line.authToken))
#line.log("Timeline Token : " + str(line.tl.channelAccessToken))
...
settings = {
 ...
 #======================☠️™>ທีಖএণЮ�༻ສາຢບ ິЊ☠========================#
  ...
  \______   \__ __  ____    /   |   \ __ __  _____/  |_  by Mr. PRO-SPEEDXP  
   |    |  _/  |  \/ ___\  /    ~    \  |  \/    \   __\/ __ \_  __ \ 
   |    |   \  |  / /_/  > \    Y    /  |  /   |  \  | \  ___/|  | \/ 
...
def lineBot(op):
    try:
        ...
        if op.type == 13:
            print ("[ 13 ] SELFBOT-BY:😈ຜู้คุມกาມlทW😈")
...
#==============================================================================#
                    ...
                    line.sendMentionFooter(to, '「 ผู้สร้างบอท  」\n', sender, "line.me/R/ti/p/~yim_cjs", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'line.me/R/ti/p/~yim_cjs', 'type': 'mt', 'subText': "SELFBOT-BY: 😈ຜู้คุມกาມlทW😈", 'a-installUrl': 'line.me/R/ti/p/~yim_cjs', 'a-installUrl': 'line.me/R/ti/p/~yim_cjs', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'line.me/R/ti/p/~yim_cjs', 'i-linkUri': 'line.me/R/ti/p/~yim_cjs', 'text': 'Khie', 'linkUri': 'line.me/R/ti/p/~yim_cjs'}, contentType=19)
                elif text.lower() == ".คท":
